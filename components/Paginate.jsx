  ...
  return (
    <div className="flex flex-col md:flex-row gap-4 mx-auto justify-center items-center text-center my-4">
        ...
        {sortedPages.map((page) => (
          <div
            ...
            className={` p-1 rounded-md align-middle ${
              page === currentPage
                ? "dark:bg-neutral-600 bg-gray-200"
                : "bg-inherit"
      ...
      <div>
        <select
          value={itemsPerPage}
          className="bg-gray-200 dark:bg-neutral-600 text-neutral-900 dark:text-neutral-200 items-center  hover:cursor-pointer  p-1 rounded-md "
      ...
      <div>
        ...
        <input
          type="number"
          label="GoToPage"
          className="bg-gray-200 dark:bg-neutral-600 text-neutral-900 dark:text-neutral-200 items-center p-1 rounded-md "
